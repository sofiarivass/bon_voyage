                        ...
                        <div className="dropdown">
                            ...
                            <form id="form-filtros" className="dropdown-menu p-3">
                                ...
                                <div className="form-check">
                                    ...
                                    <label className="form-check-label" for="pendientes">Pendientes</label>
                                </div>
                                <div className="form-check">
                                    <input type="radio" className="form-check-input" name="radioDefault" id="en_curso"/>
                                    <label className="form-check-label" for="en_curso">En curso</label>
                                </div>
                                <div className="form-check">
                                    <input type="radio" className="form-check-input" name="radioDefault" id="completados"/>
                                    <label className="form-check-label" for="completados">Completados</label>
                                </div>
                            </form>
                        </div>
                                ...
                                <form id="form-modal">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="form-section col-lg-6">
                                            <label for="imagen-viaje" className="form-label">Cargar nueva
                                                imagen</label>
                                            ...
                                            <label for="color" className="form-label mt-3">Color de la
                                                tarjeta</label>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="form-section col-md-6">
                                            <label for="ciudad" className="form-label">Ciudad/es</label>
                                    ...
                                    <div className="row mt-4">
                                        <div className="form-section col-md-4">
                                            <label for="ida" className="form-label">Fecha de ida</label>
                                            <input type="date" className="form-control" id="ida" required/>
                                        </div>
                                        <div className="form-section col-md-4">
                                            <label for="vuelta" className="form-label">Fecha de vuelta</label>
                                            <input type="date" className="form-control" id="vuelta" required/>
                                        </div>

                                        <div className="form-section col-md-4">
                                            <label for="presupuesto" className="form-label">Presupuesto
                                                estimado</label>
                                    ...
                                    <div className="form-section mt-4">
                                        <label for="notas" className="form-label">Notas</label>
